...
<div class="card">
    <div class="card-header  pb-0 p-3">
      <div class="d-flex justify-content-between">
        <h6 class="mb-2">Form Tambah Data Jabatan</h6>
      </div>
    </div>
    {{-- Form --}}
   <div class="container">
        ...
        <div class="row">
          <div class="col-md-12">
            ...
            <div class="form-group">
              <input type="text" value="{{ old('nama_jabatan') }}" class="form-control @error('nama_jabatan') is-invalid @enderror" placeholder="Masukan Nama Jabatan ..." id="nama_jabatan" name="nama_jabatan">
                @error('nama_jabatan')
